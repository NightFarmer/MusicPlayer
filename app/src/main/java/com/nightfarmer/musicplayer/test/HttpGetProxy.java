package com.nightfarmer.musicplayer.test;
...
public class HttpGetProxy {
    ...
    public String getLocalURL(String url) {
        ...
        System.out.println("proxy url...." + result);
        return result;
                    ...
                    try {
                        ...
                        while ((bytes_read = in_localSocket.read(local_request)) != -1) {
                            ...
                            if (buffer.contains("GET")
                                ...
                                buffer = buffer.replace(LOCAL_IP_ADDRESS + ":" + local_ip_port, remoteHost);
                                break;
                            }
                        }
